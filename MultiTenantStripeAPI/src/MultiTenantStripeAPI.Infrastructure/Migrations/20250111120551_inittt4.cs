...
{
    /// <inheritdoc />
    public partial class inittt4 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "View own farms and plots", "ViewOwnData" },
                    { 2, "Submit treatments", "SubmitTreatment" },
                    { 3, "Respond to audits", "RespondToAudit" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Grower role", "Grower", "tenant1-id" },
                    { 2, "Station Admin role", "StationAdmin", "tenant1-id" }
                });
